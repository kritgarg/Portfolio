...
const BootScreen = ({ onComplete }) => {
  ...
  return (
    <div className="boot-screen min-h-screen bg-black relative overflow-hidden text-white font-mono">
      ...
      {showCharacter && (
        <motion.div
          className="absolute inset-0 flex flex-col md:flex-col items-center justify-center gap-4 p-4 "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <motion.img
            src={Char}
            alt="Character"
            className="w-[200px] sm:w-[280px] md:w-[400px] md:mt-[-150px]"
              ...
              >
                ...
                <motion.img
                  ...
                  className={`
                    cursor-pointer
                    hover:scale-110
                    ${isMobile ? 'w-[150px] mt-[-40px]' : 'w-[200px] mt-[-50px] mb-[-50px] ml-[20px]'}
                  `}
